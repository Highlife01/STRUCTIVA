...
import { CheckCircle2, ArrowUpRight, ShieldCheck, Factory, Warehouse, Plane, Wheat, Mountain, Shield } from "lucide-react";
    ...
    <div className="bg-[#09131c] text-white py-16 px-4 sm:px-6 lg:px-8">
      <SEOHead
        ...
        breadcrumbs={[
          ...
          { name: "Industries & Sectors", url: `/${lang}/sectors` }
        ]}
      />
      <div className="mx-auto max-w-[1440px]">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h1 className="text-4xl sm:text-5xl font-black text-white tracking-tight mb-4">
            Sektörlere Özel <span className="text-amber-400">Çelik Yapı Çözümleri</span>
          </h1>
          <p className="text-sm text-slate-300 leading-relaxed">
            STRUCTIVA'nın 40 yıllık saha tecrübesiyle tasarlanan yapılar; tarım depolamasından maden toz tutma tesislerine, 
            uçak hangarlarından askeri flat-pack lojistik üslerine kadar her sektörün özgün çalışma mantığına göre uyarlanır.
          </p>
        </div>
            ...
            >
              <div className={`lg:col-span-6 space-y-5 ${idx % 2 === 1 ? "lg:col-start-7" : ""}`}>
                ...
                <div className="rounded-xl bg-white/5 border border-white/10 p-4">
                  <span className="text-[10px] text-amber-400 font-mono uppercase block mb-1">Tavsiye Edilen Yapı:</span>
                  <strong className="text-sm text-white">{sector.recommendedModel}</strong>
                </div>

                <div className="space-y-2">
                  <span className="text-xs font-bold uppercase tracking-wider text-slate-200 block">Sektörel Avantajlar:</span>
                ...
                <div className="pt-3">
                  ...
                  >
                    <span>Bu Sektör İçin Teknik Teklif İste</span>
              ...
              <div className={`lg:col-span-6 ${idx % 2 === 1 ? "lg:col-start-1" : ""}`}>
                <div className="rounded-2xl overflow-hidden border border-white/15 h-80 sm:h-96 shadow-2xl relative">
                  ...
                  <div className="absolute bottom-4 left-4 right-4 bg-black/60 backdrop-blur-md p-3.5 rounded-xl border border-white/10">
                    <span className="text-[10px] text-amber-400 font-mono uppercase block">Sertifikalı Uygulama</span>
                    <strong className="text-xs text-white">Tam Sızdırmaz Cıvatalı Montaj Garantisi</strong>
                  </div>
                </div>
              </div>
            </div>
